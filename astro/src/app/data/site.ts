...
import { createLocalizedHref, normalizeBase } from "../lib/paths";
...
export function getHeaderData(locale: Locale, assetBase = "/"): HeaderData {
  const isRu = locale === "ru";
  const homeHref = createLocalizedHref(assetBase, locale);
...
export function getMainData(locale: Locale, assetBase = "/"): MainData {
...
export function getFooterData(locale: Locale): FooterData {
  const isRu = locale === "ru";
