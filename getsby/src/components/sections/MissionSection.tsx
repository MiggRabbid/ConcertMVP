...
export function MissionSection({ content, assetBase, messages }: MissionSectionProps) {
  return (
      ...
      <div className={mission.el("copy")}>
        ...
        <Reveal className={mission.el("greeting")} delay={140}>
          ...
          <div className={mission.el("greeting-copy")}>
            ...
            <StubLink className={mission.el("greeting-link")}>{messages.mission.read} <FiArrowUpRight aria-hidden="true" /></StubLink>
          </div>
        </Reveal>
      </div>
